            ...
            <Marker key={i} position={[pos.lat, pos.lng]}>
              <Popup>
                <div style={{ fontSize: '0.85rem' }}>
                  <div><strong>Lat:</strong> {pos.lat.toFixed(4)}</div>
                  <div><strong>Lng:</strong> {pos.lng.toFixed(4)}</div>
                  <div><strong>Driver:</strong> {pos.driverName || 'Unknown'}</div>
                  <div><strong>Status:</strong> {pos.status || 'N/A'}</div>
                  <button
                    style={{
                      marginTop: '0.5rem',
                      padding: '4px 8px',
